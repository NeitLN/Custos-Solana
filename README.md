...
|---|---|
| **30 %** độ khó và chiều sâu | **14** luật L2, mỗi luật có ca dương **và** ca đối chứng · **719** test offline · CPI/inner instruction, ALT, legacy, nhiều signer · Token-2022 **2/26 extension** đọc được · [ma trận hành vi](docs/bao-mat/MA-TRAN-HANH-VI.md) 19 họ ca · [threat model](docs/bao-mat/THREAT-MODEL.md) 8 rủi ro |
...
| Đo trên Devnet, 15/09/2026 — lượt pass gần nhất | |
|---|---|
...
| Test | **719**, chạy trong `npm run check` |
...
|---|---|---|
| **719 test** tự động | code giữ đúng bất biến đã khoá | độ chính xác ngoài đời thật |
...
npx npm@11.6.2 run check # typecheck + 719 test
...
Measured, not estimated: **719 tests**, **38 labelled samples**, **14 rules**, average
