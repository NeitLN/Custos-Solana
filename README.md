...
| Dòng mã tích hợp | **30** |
| Một lượt kiểm tra | **668 ms** — trung vị 10 lượt trên 10 bản dựng |
...
| Test | **478**, chạy trong `npm run check` |
...
|---|---|---|
| **478 test** tự động | code giữ đúng bất biến đã khoá | độ chính xác ngoài đời thật |
...
npx npm@11.6.2 run check # typecheck + 478 test
...
Measured, not estimated: **478 tests**, **38 labelled samples**, **14 rules**, average
