...
| Test | **369**, chạy trong `npm run check` |
...
|---|---|---|
| **369 test** tự động | code giữ đúng bất biến đã khoá | độ chính xác ngoài đời thật |
...
npx npm@11.6.2 run check # typecheck + 369 test
...
Measured, not estimated: **369 tests**, **33 labelled samples**, **14 rules**, average
