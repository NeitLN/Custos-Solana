...
| Test | **953**, chạy trong `npm run check` |
...
|---|---|---|
| **953 test** tự động | code giữ đúng bất biến đã khoá | độ chính xác ngoài đời thật |
...
npx npm@11.6.2 run check # typecheck + 953 test
...
Measured, not estimated: **953 tests**, **38 labelled samples**, **14 rules**, average
