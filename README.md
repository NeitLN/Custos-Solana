...
| Dòng mã tích hợp | **30** |
| Một lượt kiểm tra | **672 ms** — trung vị 10 lượt trên 10 bản dựng |
...
| Test | **473**, chạy trong `npm run check` |
...
|---|---|---|
| **473 test** tự động | code giữ đúng bất biến đã khoá | độ chính xác ngoài đời thật |
...
npx npm@11.6.2 run check # typecheck + 473 test
...
Measured, not estimated: **473 tests**, **38 labelled samples**, **14 rules**, average
