...
| Test | **415**, chạy trong `npm run check` |
...
|---|---|---|
| **415 test** tự động | code giữ đúng bất biến đã khoá | độ chính xác ngoài đời thật |
...
npx npm@11.6.2 run check # typecheck + 415 test
...
Measured, not estimated: **415 tests**, **38 labelled samples**, **14 rules**, average
