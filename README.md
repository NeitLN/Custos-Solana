...
|---|---|
| Cài đặt → kết quả đầu tiên | **7 giây** — trung vị 10 lượt trên 4 bản dựng, dải 6,9–11,8 |
| Dòng mã tích hợp | **30** |
| Một lượt kiểm tra | **606 ms** — trung vị 10 lượt trên 4 bản dựng |
...
| Test | **391**, chạy trong `npm run check` |
...
|---|---|---|
| **391 test** tự động | code giữ đúng bất biến đã khoá | độ chính xác ngoài đời thật |
...
npx npm@11.6.2 run check # typecheck + 391 test
...
Measured, not estimated: **391 tests**, **33 labelled samples**, **14 rules**, average
