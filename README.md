...
| Test | **351**, chạy trong `npm run check` |
...
|---|---|---|
| **351 test** tự động | code giữ đúng bất biến đã khoá | độ chính xác ngoài đời thật |
...
npx npm@11.6.2 run check # typecheck + 351 test
...
Measured, not estimated: **351 tests**, **33 labelled samples**, **14 rules**, average
