...
|---|---|
| **30 %** độ khó và chiều sâu | **14** luật L2, mỗi luật có ca dương **và** ca đối chứng · **732** test offline · CPI/inner instruction, ALT, legacy, nhiều signer · Token-2022 **2/26 extension** đọc được · [ma trận hành vi](docs/bao-mat/MA-TRAN-HANH-VI.md) 19 họ ca · [threat model](docs/bao-mat/THREAT-MODEL.md) 8 rủi ro |
...
|---|---|
| SDK cài được từ ngoài repo chưa? | **Rồi** — 9,8 giây từ `npm install` tới kết quả đầu tiên, 30 dòng mã tích hợp |
...
|---|---|
| Cài đặt → kết quả đầu tiên | **9,8 giây** — trung vị 10 lượt trên 8 bản dựng, dải 7,5–15,4 |
| Dòng mã tích hợp | **30** |
...
| Test | **732**, chạy trong `npm run check` |
...
|---|---|---|
| **732 test** tự động | code giữ đúng bất biến đã khoá | độ chính xác ngoài đời thật |
...
npx npm@11.6.2 run check # typecheck + 732 test
...
Measured, not estimated: **732 tests**, **38 labelled samples**, **14 rules**, average
