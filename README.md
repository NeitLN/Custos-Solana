...
|---|---|
| SDK cài được từ ngoài repo chưa? | **Rồi** — 8,4 giây từ `npm install` tới kết quả đầu tiên, 29 dòng mã tích hợp |
...
| Dòng mã tích hợp | **29** |
| Một lượt kiểm tra | **621 ms** — trung vị 6 lượt trên 4 bản dựng |
