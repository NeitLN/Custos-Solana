...
|---|---|
| SDK cài được từ ngoài repo chưa? | **Rồi** — 7,9 giây từ `npm install` tới kết quả đầu tiên, 30 dòng mã tích hợp |
...
|---|---|
| Cài đặt → kết quả đầu tiên | **7,9 giây** — trung vị 10 lượt trên 10 bản dựng, dải 6,9–11,2 |
| Dòng mã tích hợp | **30** |
