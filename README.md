...
| Test | **355**, chạy trong `npm run check` |
...
|---|---|---|
| **355 test** tự động | code giữ đúng bất biến đã khoá | độ chính xác ngoài đời thật |
...
npx npm@11.6.2 run check # typecheck + 355 test
...
Measured, not estimated: **355 tests**, **33 labelled samples**, **14 rules**, average
