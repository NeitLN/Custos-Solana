...
|---|---|
| Cài đặt → kết quả đầu tiên | **11,7 giây** — trung vị 10 lượt trên 10 bản dựng, dải 7,2–15,9 |
| Dòng mã tích hợp | **30** |
...
| Test | **462**, chạy trong `npm run check` |
...
|---|---|---|
| **462 test** tự động | code giữ đúng bất biến đã khoá | độ chính xác ngoài đời thật |
...
npx npm@11.6.2 run check # typecheck + 462 test
...
Measured, not estimated: **462 tests**, **38 labelled samples**, **14 rules**, average
