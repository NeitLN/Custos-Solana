...
**Viết ngày 06/09/2026** · 49 commit kể từ `e09569e` · dành cho người cần nắm nhanh
...
| Tích hợp từ ngoài monorepo | **7,6 giây** tới kết quả đầu · **30 dòng** · **617 ms** một lượt |
...
```bash
npm run check                  # 1004 test + typecheck
