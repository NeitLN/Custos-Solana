...
- Bằng chứng tích hợp đo tại: `c459ba7`, cây làm việc sạch — lượt gần nhất PASS
...
|---|---|---|
| Test tự động | **722** pass · 0 fail | `npm run check` |
...
| — dải đo | **7,9–15,4 giây**, trung vị 10 lượt trên 8 bản dựng | `data/tich-hop/ket-qua.json` → `lichSuPass` |
...
|---|---|---|---|
| 1 | Lượt tích hợp gần nhất pass hay fail? | **PASS** tại `c459ba7` | `ket-qua.json` → `lastAttempt` |
...
- **722 test chứng minh code có kỷ luật, KHÔNG chứng minh độ chính xác ngoài đời.**
