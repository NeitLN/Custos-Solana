...
|---|---|---|
| Test tự động | **1136** pass · 0 fail | `npm run check` |
...
| — dải đo | **6,6–13,2 giây**, trung vị 10 lượt trên 9 bản dựng | `data/tich-hop/ket-qua.json` → `lichSuPass` |
| — dòng mã tích hợp | **31** | `vi-du-tich-hop/src/tich-hop.js` |
...
- **1136 test chứng minh code có kỷ luật, KHÔNG chứng minh độ chính xác ngoài đời.**
