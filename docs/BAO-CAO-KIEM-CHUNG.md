...
- Bằng chứng tích hợp đo tại: `298283f`, cây làm việc sạch — lượt gần nhất PASS
...
| — dải đo | **6,9–11,8 giây**, trung vị 10 lượt trên 5 bản dựng | `data/tich-hop/ket-qua.json` → `lichSuPass` |
...
|---|---|---|---|
| 1 | Lượt tích hợp gần nhất pass hay fail? | **PASS** tại `298283f` | `ket-qua.json` → `lastAttempt` |
