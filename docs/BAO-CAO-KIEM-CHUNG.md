...
- Bằng chứng tích hợp đo tại: `c101f05`, cây làm việc sạch — lượt gần nhất PASS
...
|---|---|---|
| Test tự động | **828** pass · 0 fail | `npm run check` |
...
| — dải đo | **6,9–11,8 giây**, trung vị 10 lượt trên 10 bản dựng | `data/tich-hop/ket-qua.json` → `lichSuPass` |
...
|---|---|---|---|
| 1 | Lượt tích hợp gần nhất pass hay fail? | **PASS** tại `c101f05` | `ket-qua.json` → `lastAttempt` |
...
- **828 test chứng minh code có kỷ luật, KHÔNG chứng minh độ chính xác ngoài đời.**
