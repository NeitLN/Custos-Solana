...
- Bằng chứng tích hợp đo tại: `9f5faf9`, cây làm việc sạch — lượt gần nhất PASS
...
|---|---|---|
| Test tự động | **483** pass · 0 fail | `npm run check` |
...
| Tích hợp từ ngoài monorepo | **12 giây** tới kết quả đầu | `npm run thu-tich-hop:devnet` |
...
| — một lượt `inspect()` | **668 ms** | cùng file |
...
|---|---|---|---|
| 1 | Lượt tích hợp gần nhất pass hay fail? | **PASS** tại `9f5faf9` | `ket-qua.json` → `lastAttempt` |
...
- **483 test chứng minh code có kỷ luật, KHÔNG chứng minh độ chính xác ngoài đời.**
