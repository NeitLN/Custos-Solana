...
- Bằng chứng tích hợp đo tại: `74e0ffb`, cây làm việc sạch — lượt gần nhất PASS
...
|---|---|---|
| Test tự động | **763** pass · 0 fail | `npm run check` |
...
| — dải đo | **6,9–15,4 giây**, trung vị 10 lượt trên 10 bản dựng | `data/tich-hop/ket-qua.json` → `lichSuPass` |
...
|---|---|---|---|
| 1 | Lượt tích hợp gần nhất pass hay fail? | **PASS** tại `74e0ffb` | `ket-qua.json` → `lastAttempt` |
...
- **763 test chứng minh code có kỷ luật, KHÔNG chứng minh độ chính xác ngoài đời.**
