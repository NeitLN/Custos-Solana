...
- Bằng chứng tích hợp đo tại: `8cba3de`, cây làm việc sạch — lượt gần nhất PASS
...
| Tích hợp từ ngoài monorepo | **8,4 giây** tới kết quả đầu | `npm run thu-tich-hop:devnet` |
...
| — một lượt `inspect()` | **638 ms** | cùng file |
...
|---|---|---|---|
| 1 | Lượt tích hợp gần nhất pass hay fail? | **PASS** tại `8cba3de` | `ket-qua.json` → `lastAttempt` |
