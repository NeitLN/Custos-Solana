...
- Bằng chứng tích hợp đo tại: `9e6cf19`, cây làm việc sạch — lượt gần nhất PASS
...
| Tích hợp từ ngoài monorepo | **7,6 giây** tới kết quả đầu | `npm run thu-tich-hop:devnet` |
...
| — một lượt `inspect()` | **617 ms** | cùng file |
...
|---|---|---|---|
| 1 | Lượt tích hợp gần nhất pass hay fail? | **PASS** tại `9e6cf19` | `ket-qua.json` → `lastAttempt` |
