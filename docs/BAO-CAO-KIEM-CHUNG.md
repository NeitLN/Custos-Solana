...
- Bằng chứng tích hợp đo tại: `8ed5ec9`, cây làm việc sạch — lượt gần nhất PASS
...
|---|---|---|
| Test tự động | **732** pass · 0 fail | `npm run check` |
...
| Tích hợp từ ngoài monorepo | **9,8 giây** tới kết quả đầu | `npm run thu-tich-hop:devnet` |
...
|---|---|---|---|
| 1 | Lượt tích hợp gần nhất pass hay fail? | **PASS** tại `8ed5ec9` | `ket-qua.json` → `lastAttempt` |
...
- **732 test chứng minh code có kỷ luật, KHÔNG chứng minh độ chính xác ngoài đời.**
