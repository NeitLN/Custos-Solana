...
- Bằng chứng tích hợp đo tại: `13c8482`, cây làm việc sạch — lượt gần nhất PASS
...
| — dải đo | **6,9–11,8 giây**, trung vị 10 lượt trên 3 bản dựng | `data/tich-hop/ket-qua.json` → `lichSuPass` |
...
|---|---|---|---|
| 1 | Lượt tích hợp gần nhất pass hay fail? | **PASS** tại `13c8482` | `ket-qua.json` → `lastAttempt` |
