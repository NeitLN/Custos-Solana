...
- Bằng chứng tích hợp đo tại: `24f79c5`, cây làm việc sạch — lượt gần nhất PASS
...
| — dải đo | **6,9–11,8 giây**, trung vị 10 lượt trên 4 bản dựng | `data/tich-hop/ket-qua.json` → `lichSuPass` |
