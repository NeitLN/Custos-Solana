...
- Bằng chứng tích hợp đo tại: `6abb15a`, cây làm việc sạch — lượt gần nhất PASS
...
|---|---|---|
| Test tự động | **730** pass · 0 fail | `npm run check` |
...
| Tích hợp từ ngoài monorepo | **10,9 giây** tới kết quả đầu | `npm run thu-tich-hop:devnet` |
| — dải đo | **7,5–15,4 giây**, trung vị 10 lượt trên 8 bản dựng | `data/tich-hop/ket-qua.json` → `lichSuPass` |
...
|---|---|---|---|
| 1 | Lượt tích hợp gần nhất pass hay fail? | **PASS** tại `6abb15a` | `ket-qua.json` → `lastAttempt` |
...
- **730 test chứng minh code có kỷ luật, KHÔNG chứng minh độ chính xác ngoài đời.**
