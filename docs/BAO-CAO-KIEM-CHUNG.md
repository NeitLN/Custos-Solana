...
- Bằng chứng tích hợp đo tại: `308d706`, cây làm việc sạch — lượt gần nhất PASS
...
|---|---|---|
| Test tự động | **467** pass · 0 fail | `npm run check` |
...
| — một lượt `inspect()` | **677 ms** | cùng file |
...
|---|---|---|---|
| 1 | Lượt tích hợp gần nhất pass hay fail? | **PASS** tại `308d706` | `ket-qua.json` → `lastAttempt` |
...
- **467 test chứng minh code có kỷ luật, KHÔNG chứng minh độ chính xác ngoài đời.**
