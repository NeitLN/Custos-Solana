...
- Bằng chứng tích hợp đo tại: `5413f61`, cây làm việc sạch — lượt gần nhất PASS
...
|---|---|---|
| Test tự động | **448** pass · 0 fail | `npm run check` |
...
| Tích hợp từ ngoài monorepo | **9,4 giây** tới kết quả đầu | `npm run thu-tich-hop:devnet` |
...
| — một lượt `inspect()` | **671 ms** | cùng file |
...
|---|---|---|---|
| 1 | Lượt tích hợp gần nhất pass hay fail? | **PASS** tại `5413f61` | `ket-qua.json` → `lastAttempt` |
...
- **448 test chứng minh code có kỷ luật, KHÔNG chứng minh độ chính xác ngoài đời.**
