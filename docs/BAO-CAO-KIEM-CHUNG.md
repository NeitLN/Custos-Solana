...
- Bằng chứng tích hợp đo tại: `f8ee7ab`, cây làm việc sạch — lượt gần nhất PASS
...
| — dải đo | **8–19,4 giây**, trung vị 10 lượt trên 8 bản dựng | `data/tich-hop/ket-qua.json` → `lichSuPass` |
...
|---|---|---|---|
| 1 | Lượt tích hợp gần nhất pass hay fail? | **PASS** tại `f8ee7ab` | `ket-qua.json` → `lastAttempt` |
