...
- Bằng chứng tích hợp đo tại: `df91026`, cây làm việc sạch — lượt gần nhất PASS
...
|---|---|---|
| Test tự động | **775** pass · 0 fail | `npm run check` |
...
| — một lượt `inspect()` | **639 ms** | cùng file |
...
|---|---|---|---|
| 1 | Lượt tích hợp gần nhất pass hay fail? | **PASS** tại `df91026` | `ket-qua.json` → `lastAttempt` |
...
- **775 test chứng minh code có kỷ luật, KHÔNG chứng minh độ chính xác ngoài đời.**
