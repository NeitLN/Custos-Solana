...
- Bằng chứng tích hợp đo tại: `2364082`, cây làm việc sạch — lượt gần nhất PASS
...
|---|---|---|
| Test tự động | **816** pass · 0 fail | `npm run check` |
...
| Tích hợp từ ngoài monorepo | **8,7 giây** tới kết quả đầu | `npm run thu-tich-hop:devnet` |
...
|---|---|---|---|
| 1 | Lượt tích hợp gần nhất pass hay fail? | **PASS** tại `2364082` | `ket-qua.json` → `lastAttempt` |
...
- **816 test chứng minh code có kỷ luật, KHÔNG chứng minh độ chính xác ngoài đời.**
