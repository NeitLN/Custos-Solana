...
- Bằng chứng tích hợp đo tại: `4004570`, cây làm việc sạch — lượt gần nhất PASS
...
|---|---|---|
| Test tự động | **740** pass · 0 fail | `npm run check` |
...
| — dải đo | **7,5–15,4 giây**, trung vị 10 lượt trên 9 bản dựng | `data/tich-hop/ket-qua.json` → `lichSuPass` |
...
|---|---|---|---|
| 1 | Lượt tích hợp gần nhất pass hay fail? | **PASS** tại `4004570` | `ket-qua.json` → `lastAttempt` |
...
- **740 test chứng minh code có kỷ luật, KHÔNG chứng minh độ chính xác ngoài đời.**
