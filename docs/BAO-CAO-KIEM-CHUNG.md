...
- Bằng chứng tích hợp đo tại: `82e51a3`, cây làm việc sạch — lượt gần nhất PASS
...
|---|---|---|
| Test tự động | **487** pass · 0 fail | `npm run check` |
...
| Tích hợp từ ngoài monorepo | **11,7 giây** tới kết quả đầu | `npm run thu-tich-hop:devnet` |
...
| — một lượt `inspect()` | **664 ms** | cùng file |
...
|---|---|---|---|
| 1 | Lượt tích hợp gần nhất pass hay fail? | **PASS** tại `82e51a3` | `ket-qua.json` → `lastAttempt` |
...
- **487 test chứng minh code có kỷ luật, KHÔNG chứng minh độ chính xác ngoài đời.**
