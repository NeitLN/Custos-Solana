...
|---|---|---|---|---|
| Test tự động | **953** | `npm run check` | offline, không mạng | ✅ hiện hành |
...
| Cài từ ngoài repo tới kết quả đầu | **7,8 giây** | `data/tich-hop/ket-qua.json` | trung vị 10 lượt, cài từ tarball ngoài repo — số bản dựng và dải nằm ở README, không chép lại ở đây | ✅ |
