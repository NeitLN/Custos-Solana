...
| Cài từ ngoài repo tới kết quả đầu | **7,6 giây** | `data/tich-hop/ket-qua.json` | trung vị 10 lượt, cài từ tarball ngoài repo — số bản dựng và dải nằm ở README, không chép lại ở đây | ✅ |
| Một lượt `inspect()` | **617 ms** | như trên | trung vị 10 lượt | ✅ |
