...
mua** đúng năng lực Custos đang làm.

**Nhưng đừng gọi nó là "market validation".** Thương vụ chứng minh năng lực này đáng
tiền **với Phantom**; nó không xác thực nhóm khách hàng của Custos, không xác thực
mức giá, và không nói ai sẽ trả. Gọi tên to hơn bằng chứng là cách nhanh nhất để mất
đúng ô mà mình đang cố ghi điểm.

Và nó đọc được hai cách. Cách bất lợi: Phantom mua xong thì **đóng dịch vụ bán rời** —
tức có thể năng lực này đang bị kéo vào nội bộ chứ không phải mở ra một thị trường bán
rời. Giám khảo mảng này nghĩ ra cách đọc đó trong ba giây, nên đội phải nói trước.

Câu để dành cho phần mô hình kinh doanh:

> *"Phantom mua đứt Blowfish rồi đóng dịch vụ bán rời của nó — ví lớn nhất Solana đã
> trả tiền cho đúng năng lực này. Chuyện đó đọc được hai cách: thị trường có thật,
> hoặc năng lực này bị mua về làm nội bộ. Blockaid vẫn bán cho ví khác nên cách thứ
> nhất còn sống, nhưng chúng em chưa có ví nào nói sẽ trả bao nhiêu — đó vẫn là ô
> trống, và bọn em không tính nó thành điểm mạnh."*
...
### 14. "458 test chứng minh Custos chính xác chứ?" — ĐỪNG gật

Cái bẫy tự khen. 458 test chứng minh **code có kỷ luật**, KHÔNG chứng minh precision/
recall. Gộp hai thứ là mất liêm chính. Tách rõ **bốn loại bằng chứng, đo bốn thứ khác
nhau**:

| Loại | Đo cái gì | KHÔNG đo cái gì |
|---|---|---|
| **Unit/integration (458)** | Code chạy đúng đặc tả | Không đo độ chính xác trên đời thật |
...
> Câu nói được: *"Chúng em có bốn loại bằng chứng cho bốn câu hỏi khác nhau. 458 test
...
`npm audit` cho 11 lỗ hổng (5 high, 6 moderate) tính tới ngày đo gần nhất. Chia hai
