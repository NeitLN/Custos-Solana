...
### 14. "749 test chứng minh Custos chính xác chứ?" — ĐỪNG gật

Cái bẫy tự khen. 749 test chứng minh **code có kỷ luật**, KHÔNG chứng minh precision/
recall. Gộp hai thứ là mất liêm chính. Tách rõ **bốn loại bằng chứng, đo bốn thứ khác
nhau**:

| Loại | Đo cái gì | KHÔNG đo cái gì |
|---|---|---|
| **Unit/integration (749)** | Code chạy đúng đặc tả | Không đo độ chính xác trên đời thật |
...
> Câu nói được: *"Chúng em có bốn loại bằng chứng cho bốn câu hỏi khác nhau. 749 test
